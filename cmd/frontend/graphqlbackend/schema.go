...
type Mutation {
    ...
    # Import threads from an external service. Returns the threads.
    importThreadsFromExternalService(input: ImportThreadsFromExternalServiceInput!): [Thread!]!
...
# Input arguments for importing threads from an external service.
#
# EXPERIMENTAL
input ImportThreadsFromExternalServiceInput {
    # Import a single thread by repository and number.
    byRepositoryAndNumber: ExternalThreadRepositoryAndNumber

    # Import all threads that match a query on the external service.
    byQuery: String
}

# A specification of a thread on an external service by its repository and number.
input ExternalThreadRepositoryAndNumber {
    # The name of the repository that contains the thread.
    repositoryName: String!
